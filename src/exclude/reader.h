 ...
 * Wątek czytelnika próbuje uzyskać dostęp do czytelni, redukując liczbę czytelników w kolejce
 ...
 * Po odczekaniu czasu odpoczynku, zwiększa liczbę czytelników w kolejce i kontynuuje działanie w pętli.
 */
